            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="./profile.php?recruitment_id=<?= $row['recruitmentId'] ?>&recruitmentId_name=<?= $row['fullName'] ?>"><button type="button" class="btn btn-primary" name="detail">Detail</button></a>
                        </td>
                    <tr>
                    <?php } ?>
            </tbody>
